...
# -*- coding: utf-8 -*-
"""
⚠️ [已弃用] AkShare数据适配器 - DEPRECATED in Phase 6.1.1
============================================================
...
替代方案：
- 使用 logic/data_providers/tushare_provider.py 替代
- 全市场数据使用 TushareProvider.get_daily_all()
- 个股数据使用 TushareProvider.get_stock_daily()
...
import warnings
warnings.warn(
    "data_adapter_akshare.py 已在Phase 6.1.1中弃用，请使用 tushare_provider.py 替代",
    DeprecationWarning,
    stacklevel=2
)
