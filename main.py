...
with st.sidebar:
    ...
    app_mode = st.radio(
        "选择功能模块",
        [
            "📊 仪表盘首页",  # 🆕 V19.5.3 新增：系统健康监控和数据记录情况
...
if app_mode == "📊 仪表盘首页":
    # 仪表盘首页 - 系统健康监控和数据记录情况
    with st.spinner("正在加载仪表盘首页..."):
        render_dashboard_home = load_ui_module('ui.dashboard_home', 'render_dashboard_home')
    ...
    with t6:
        ...
        st.markdown("---")
        st.markdown("### 🌐 V17.1 Time-Sync (时区校准)")
        st.caption("统一系统时钟源，确保所有交易时间判断都基于北京时间")
        
        with st.spinner("正在加载时区校准引擎..."):
    ...
    # 交易策略模块
    t1, t2, t3, t4, t5, t6, t7, t8, t9, t10, t11, t12, t13, t14, t15, t16, t17, t18, t19 = st.tabs(["🔮 预测雷达", "🔥 龙头战法", "📈 均线战法", "🎯 打板预测", "⚡ 集合竞价", "📊 量价关系", "💰 游资席位", "🔍 买点扫描", "🕸️ 关系图谱", "👤 游资画像", "📈 短期涨跌", "🔮 机会预测", "🤖 多智能体", "📰 智能新闻", "🧠 实时情绪感知", "🐉 龙头识别跟踪", "⚡ 竞价预测系统", "🔧 在线参数调整", "🎮 历史重演"])
    with t1:
        # 🆕 V12 第三阶段：预测雷达
