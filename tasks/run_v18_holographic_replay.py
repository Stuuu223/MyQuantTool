...
# 直接导入V18核心，绕过可能出错的__init__.py
import importlib.util
spec = importlib.util.spec_from_file_location(
    "unified_warfare_core_v18",
    "E:/MyQuantTool/logic/strategies/unified_warfare_core_v18.py"
)
module = importlib.util.module_from_spec(spec)
spec.loader.exec_module(module)
UnifiedWarfareCoreV18 = module.UnifiedWarfareCoreV18
