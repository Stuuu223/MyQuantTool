...
SCORE_BASELINES = {
    '300997_20260129': {
        'min': 0.0, 'max': 500.0,
        'label': (
            '欢乐家诱多案例 - 在收盘时间(15:00)由price_momentum+5次方摩擦联合压制 '
            '[UNVERIFIED: 盘中10:00-14:00时段price_momentum单独拦截效果未验证]'
        )
    },
    '603697_20260202': {
        'min': 0.0, 'max': 500.0,
        'label': (
            '有友食品出货案例 - 在收盘时间(15:00)由price_momentum+5次方摩擦联合压制 '
            '[UNVERIFIED: 阈值0.57基于2样本反向拟合，统计不显著]'
        )
    },
}
