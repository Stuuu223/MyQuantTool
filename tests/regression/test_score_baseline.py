...
SCORE_BASELINES = {
    '300997_20260129': {
        'min': 0.0, 'max': 15000.0,  # 【CTO V110】重力逃逸豁免后分数飙升
        'label': '欢乐家 - V110重力逃逸(翻红+高于开盘+涨幅>3%+站稳VWAP)享受豁免'
    },
    '603697_20260202': {
        'min': 0.0, 'max': 30000.0,  # 【CTO V110】重力逃逸豁免后分数飙升
        'label': '有友食品 - V110重力逃逸(翻红+高于开盘+涨幅>3%+站稳VWAP)享受豁免'
    },
}
