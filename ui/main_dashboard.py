...
# 🆕 V9.0 新增
from ui.v90_predator_tab import render_v90_predator_tab

# 🆕 V9.0 新增
from ui.v90_features_tab import render_v90_features_tab

# 🆕 V9.1 新增
from ui.v91_seal_strength_tab import render_v91_seal_strength_tab
...
def main():
    ...
    page = st.sidebar.radio(
        "选择功能页面",
        ["主页", "交易执行", "组合优化", "市场情绪", "策略工厂", "参数优化", "策略对比", "可视化分析", "🚀 V6.1新功能", "🎯 V7.0统合优化", "⚡ V7.1终极展望", "🔮 V8.0物理执行", "🎯 V8.1流动性与真龙识别", "🛡️ V8.4数据防火墙", "🦖 V9.0游资掠食者", "🔄 V9.0日内弱转强", "🛑 V9.1封单强度熔断"]
    )
    ...
    if page == "主页":
        ...
        render_v90_predator_tab(None, None)
    elif page == "🔄 V9.0日内弱转强":
        render_v90_features_tab(None, None)
    elif page == "🛑 V9.1封单强度熔断":
        render_v91_seal_strength_tab(None, None)
